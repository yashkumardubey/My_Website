...
<body>
    ...
    <main class="main-content">
        ...
        <section id="skills" class="section">
            ...
            <p>A brief overview of my technical skills and proficiencies.</p>
            <!-- Skills content goes here -->
        </section>
        <section id="experience" class="section">
            <div class="section-title">💼 Professional Experience</div>
            <p>A summary of my professional experience and roles.</p>
            <!-- Experience content goes here -->
        </section>
        <section id="projects" class="section">
            <div class="section-title">🚀 Key Projects</div>
            <p>Details about my key projects and contributions.</p>
        ...
        <section id="blog" class="section">
            ...
            <p>Links to my blog posts and articles.</p>
