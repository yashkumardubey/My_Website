...
<body>
    ...
    <main class="main-content">
        ...
        <section id="projects" class="section">
            ...
            <p>Secure CI/CD Pipeline, PostgreSQL HA Setup, GitBucket On-Prem & SOP.</p>
        </section>
        <section id="education" class="section">
            <div class="section-title">🎓 Education</div>
            <p>Bachelor of Computer Applications (BCA) from Sanskriti University, Mathura.</p>
        </section>
        ...
        <section id="blog" class="section">
            ...
            <p>How to Build a Secure CI/CD Pipeline with Jenkins & GitBucket.</p>
        </section>
